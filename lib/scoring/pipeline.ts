...
export async function scoreProject(projectId: string): Promise<void> {
  ...
  await supabaseAdmin.from('current_scores').upsert({
    ...
    community_twitter_followers: result.community_twitter_followers,
    community_telegram_members: result.community_telegram_members,
    community_reddit_subscribers: result.community_reddit_subscribers,
    community_total_followers: result.community_total_followers,
    community_data_available: result.community_data_available,
